...
- HYP-EMERGENT_SOURCE_ENACTMENT: Which distinctions, dependencies or representation failures among enactment, Temporal, conduct, Expectation, present, future, practice, repeated, waiting become invisible when the current topic registry determines the problem in advance? (6 selector candidates)
