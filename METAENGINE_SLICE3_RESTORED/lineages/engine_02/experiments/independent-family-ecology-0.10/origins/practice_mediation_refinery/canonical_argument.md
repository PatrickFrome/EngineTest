...
- OOXML-native segments: 10
- Renderer-native units: 8
- Argument-native units: 3
- OMML formulas: 0
...
- HYP-EMERGENT_SOURCE_MEDIATION: Which distinctions, dependencies or representation failures among mediation, Practice, bodily, conduct, material, mediated, objects, performance, place, repeated become invisible when the current topic registry determines the problem in advance? (6 selector candidates)
