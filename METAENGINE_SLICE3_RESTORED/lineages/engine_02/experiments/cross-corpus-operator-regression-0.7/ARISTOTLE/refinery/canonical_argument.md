# Canonical argument scaffold — Corpus Refinery 0.3.0
...
- OOXML-native segments: 19
- Renderer-native units: 14
- Argument-native units: 7
- OMML formulas: 0
- Catalog source targets: 0; resolved claim-level citations: 0
- Exact duplicate groups: 0; no segment was deleted

## Hypothesis queue

- HYP-EMERGENT_SOURCE_SUBSTANCE: Which distinctions, dependencies or representation failures among substance, reference, explained, predicable, present, substances become invisible when the current topic registry determines the problem in advance? (10 selector candidates)
- HYP-EMERGENT_CLAIM_LOCAL_MODE_VARIATION: Which source-bounded discriminators support, qualify or defeat the project thesis “LOCAL_MODE_VARIATION” without presupposing the current registry? (9 selector candidates)
- HYP-EMERGENT_CLAIM_GLOBAL_RELATION_FIRST: Which source-bounded discriminators support, qualify or defeat the project thesis “GLOBAL_RELATION_FIRST” without presupposing the current registry? (11 selector candidates)
