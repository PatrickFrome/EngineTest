...
- HYP-EMERGENT_SOURCE_LANGUE: Which distinctions, dependencies or representation failures among langue, système, différences, sens, sons become invisible when the current topic registry determines the problem in advance? (8 selector candidates)
- HYP-EMERGENT_CLAIM_DIFFERENTIAL_CONSTITUTION: Which source-bounded discriminators support, qualify or defeat the project thesis “DIFFERENTIAL_CONSTITUTION” without presupposing the current registry? (9 selector candidates)
- HYP-EMERGENT_CLAIM_GLOBAL_RELATION_FIRST: Which source-bounded discriminators support, qualify or defeat the project thesis “GLOBAL_RELATION_FIRST” without presupposing the current registry? (9 selector candidates)
