...
|---|---:|
| QUESTION | 3 |
| UNRESOLVED_ASSERTION | 2 |

- OOXML-native segments: 5
- Renderer-native units: 40
- Argument-native units: 5
- OMML formulas: 0
...
- HYP-EMERGENT_SOURCE_NOT: Which distinctions, dependencies or representation failures among not, But, public, than, religion, religious, would, Mussulmans, pork become invisible when the current topic registry determines the problem in advance? (5 selector candidates)
