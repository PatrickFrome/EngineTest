...
| CONCLUSION | 2 |
| QUESTION | 1 |
| UNRESOLVED_ASSERTION | 3 |

- OOXML-native segments: 11
- Renderer-native units: 34
- Argument-native units: 6
- OMML formulas: 0
...
- HYP-EMERGENT_SOURCE_BUT: Which distinctions, dependencies or representation failures among but, not, all, Government, who, British, Christians, Toleration become invisible when the current topic registry determines the problem in advance? (4 selector candidates)
